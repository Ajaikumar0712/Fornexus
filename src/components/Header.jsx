        ...
        >
            <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <nav className="hidden md:flex space-x-8 text-sm font-medium">
                    ...
                    <a href="#autofix" className="hover:text-indigo-400 transition-colors text-indigo-300 font-semibold">AutoFix </a>
            ...
            >
                ...
                <a href="#autofix" className="block py-2 px-4 text-sm hover:bg-gray-800 text-indigo-300 font-semibold">AutoFix 🛡️</a>
